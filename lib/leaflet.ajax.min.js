  ...
  function a(b, c, d) {
    ...
    return (
      g.exports ||
        ...
        g.call(this, g.exports, a.relative(e), g)),
      g.exports
    );
  }
  (a.modules = {}),
    ...
    a.register(
      "calvinmetcalf-setImmediate/lib/postMessage.js",
      function (a, b) {
        "use strict";
        var c = b("./global");
        (a.test = function () {
    ...
    a.register(
      "calvinmetcalf-setImmediate/lib/messageChannel.js",
      function (a, b) {
        "use strict";
        var c = b("./global");
        (a.test = function () {
    ...
    a.register(
      "calvinmetcalf-setImmediate/lib/stateChange.js",
      function (a, b) {
        "use strict";
        var c = b("./global");
        (a.test = function () {
          return (
            "document" in c &&
            "onreadystatechange" in c.document.createElement("script")
          );
        }),
          (a.install = function (a) {
            return function () {
              ...
              return (
                ...
                c.document.documentElement.appendChild(b),
                a
              );
            };
          });
    ...
    a.register("lie/lie.js", function (a, b, c) {
      function d(a) {
        ...
        function h(a, b) {
          for (
            var d, h, i = a ? "resolve" : "reject", j = 0, m = k.length;
            m > j;
            j++
          )
            (d = k[j]),
    ...
    a.alias(
      "calvinmetcalf-setImmediate/lib/index.js",
      "lie/deps/immediate/lib/index.js"
    ),
    a.alias(
      "calvinmetcalf-setImmediate/lib/nextTick.js",
      "lie/deps/immediate/lib/nextTick.js"
    ),
    a.alias(
      "calvinmetcalf-setImmediate/lib/postMessage.js",
      "lie/deps/immediate/lib/postMessage.js"
    ),
    a.alias(
      "calvinmetcalf-setImmediate/lib/messageChannel.js",
      "lie/deps/immediate/lib/messageChannel.js"
    ),
    a.alias(
      "calvinmetcalf-setImmediate/lib/stateChange.js",
      "lie/deps/immediate/lib/stateChange.js"
    ),
    a.alias(
      "calvinmetcalf-setImmediate/lib/timeout.js",
      "lie/deps/immediate/lib/timeout.js"
    ),
    a.alias(
      "calvinmetcalf-setImmediate/lib/global.js",
      "lie/deps/immediate/lib/global.js"
    ),
    a.alias(
      "calvinmetcalf-setImmediate/lib/mutation.js",
      "lie/deps/immediate/lib/mutation.js"
    ),
    a.alias(
      "calvinmetcalf-setImmediate/lib/index.js",
      "lie/deps/immediate/index.js"
    ),
    a.alias("calvinmetcalf-setImmediate/lib/index.js", "immediate/index.js"),
    a.alias(
      "calvinmetcalf-setImmediate/lib/index.js",
      "calvinmetcalf-setImmediate/index.js"
    ),
    a.alias("lie/lie.js", "lie/index.js"),
    (L.Util.Promise = a("lie"));
})(),
        ...
        (request = new Ajax()),
          ...
          (request.onreadystatechange = function () {
            4 === request.readyState &&
              ((request.status < 400 && options.local) || 200 === request.status
                ? (window.JSON
  ...
  (L.Util.jsonp = function (a, b) {
    ...
    var c,
      ...
      i = L.Util.Promise(function (i, j) {
        ...
        b.callbackName
          ? (c = b.callbackName)
          : ((e = "_" + ("" + Math.random()).slice(2)),
            (c = "L.Util.jsonp.cb." + e)),
          (h.type = "text/javascript"),
          e &&
            (L.Util.jsonp.cb[e] = function (a) {
  ...
  (L.GeoJSON.AJAX = L.GeoJSON.extend({
    ...
    initialize: function (a, b) {
      (this.urls = []),
        a &&
          ("string" == typeof a
            ? this.urls.push(a)
            : "function" == typeof a.pop
            ? (this.urls = this.urls.concat(a))
            : ((b = a), (a = void 0)));
    ...
    addUrl: function (a) {
      ...
      a &&
        ("string" == typeof a
          ? b.urls.push(a)
          : "function" == typeof a.pop && (b.urls = b.urls.concat(a)));
      var c = b.urls.length,
        d = 0;
      b.fire("data:loading"),
        b.urls.forEach(function (a) {
          "json" === b.ajaxParams.dataType.toLowerCase()
            ? L.Util.ajax(a, b.ajaxParams).then(
                function (a) {
            ...
            : "jsonp" === b.ajaxParams.dataType.toLowerCase() &&
              L.Util.jsonp(a, b.ajaxParams).then(
                function (a) {
                  var c = b.ajaxParams.middleware(a);
                  b.addData(c), b.fire("data:progress", c);
                },
      ...
      "function" != typeof a
        ...
        : ((this.filter = a),
          this.eachLayer(function (b) {
            a(b.feature)
              ? b.setStyle({ stroke: !0, clickable: !0 })
              : b.setStyle({ stroke: !1, clickable: !1 });
          }));
    },
  })),
